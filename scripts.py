...
╰─────────────────⍟"""
    ...
    HELP_TEXT = """
<i>𝐖𝐚𝐭𝐜𝐡 𝐕𝐢𝐝𝐞𝐨 𝐇𝐨𝐰 𝐭𝐨 𝐔𝐬𝐞 𝐌𝐞 <a href='https://t.me/+yP9ckmsoGF1kNDNl'>[ ᴄʟɪᴄᴋ ʜᴇʀᴇ ]</a></i>\n
...
╭────[🔅Rᴇɴᴀᴍᴇʀ Bᴏᴛ🔅]───⍟
│
├<b>🤖 Bot Name : <a href='http://t.me/My_Rename_RoBoT'>My Rename Bot</a></b>
│
├<b>📢 Channel : <a href='https://t.me/malayali00l'>@malayali00l</a></b>
│
├<b>👥 Version : <a href='https://t.me/MMCINEMACHAKKU'>Join group</a></b>
│
├<b>💢 Join Group : <a href='https://t.me/MMCINEMACHAKKU'>Click Here</a></b>
│
├<b>🌐 Upload Channel : <a href='https://t.me/+yP9ckmsoGF1kNDNl'>Join</a></b>
│
├<b>📕 Library : <a href='https://t.me/+yP9ckmsoGF1kNDNl'>Join</a></b>
│
├<b>㊙ Language: <a href='https://www.python.org'>Python 3.9.4</a></b>
│
├<b>👨‍💻 Developer : <a href='https://t.me/cinemaclubcc'>DeeZuZza</a></b>
│
├<b>🚸 Powered By : <a href='https://t.me/Cinema_Club_Post'>@Cinema_Club_Post</a></b>
│
╰──────[Thanks 😊]───⍟"""
    ...
    UPLOAD_SUCCESS = "<u><i>Tʜᴀɴᴋs Fᴏʀ Usɪɴɢ ᴍᴇ❤ Join @MMCINEMACHAKKU</i></u>"
    ...
    CONTACT_MY_DEVELOPER = "<i>Something Went Wrong! Contact in Support Group @MMCINEMACHAKKU for Help. </i>"
    START_TEXT = "<i>This is a Fastest File Renamer and Converter Bot With Permanant Thumbnail Support💯</i>"
    UPGRADE_TEXT = "<b>To upgrade your subscription <a href='https://t.me/cinemaclubcc'>[Click Here]</a></b>"
